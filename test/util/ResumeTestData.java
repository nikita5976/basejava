...
public class ResumeTestData {
    ...
    private static void filingExperienceTestResume(Resume testResume) {
        ...
        testResume.setSectionExperience(4, 2012, 10, 2014, "RIT Center", "",
        ...
        testResume.setSectionExperience(12, 2010, 4, 2012, "Luxoft (Deutsche Bank)", "http://www.luxoft.ru/",
        ...
        testResume.setSectionExperience(6, 2008, 12, 2010, "Yota", "https://www.yota.ru/",
        ...
        testResume.setSectionExperience(3, 2007, 6, 2008, "Enkata", "http://enkata.com/",
        ...
        testResume.setSectionExperience(1, 2005, 2, 2007, "Siemens AG", "https://www.siemens.com/ru/ru/home.html",
        ...
        testResume.setSectionExperience(9, 1997, 1, 2005, "Alcatel", "http://www.alcatel.ru/",
    ...
    private static void filingEducationTestResume(Resume testResume) {
        ...
        testResume.setSectionEducation(3, 2011, 4, 2011, "Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366",
                "Курс 'Объектно-ориентированный анализ ИС. Концептуальное моделирование на UML.");

        testResume.setSectionEducation(1, 2005, 4, 2005, "Siemens AG", "http://www.siemens.ru/",
                "3 месяца обучения мобильным IN сетям (Берлин)");

        testResume.setSectionEducation(9, 1997, 3, 1998, "Alcatel", "http://www.alcatel.ru/",
                "6 месяцев обучения цифровым телефонным сетям (Москва)");

        testResume.setSectionEducation(9, 1993, 7, 1996, "Санкт-Петербургский национальный исследовательский " +
                        "университет информационных технологий, механики и оптики", "http://www.ifmo.ru/",
                "Аспирантура (программист С, С++)");

        testResume.setSectionEducation(9, 1987, 7, 1993, "Санкт-Петербургский национальный исследовательский " +
                        "университет информационных технологий, механики и оптики", "http://www.ifmo.ru/",
                "Инженер (программист Fortran, C)");

        testResume.setSectionEducation(9, 1984, 6, 1987, "Заочная физико-техническая школа при МФТИ", "https://mipt.ru/",
                "Закончил с отличием");
    }
}
